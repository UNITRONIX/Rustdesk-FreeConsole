...
const KEYS = {
    ...
    channel_desc: {
        ar: 'Choose where the panel checks for updates. Production servers should use Stable.',
        cs: 'Vyberte, odkud panel kontroluje aktualizace. Na produkci používejte Stable.',
        da: 'Vælg hvor panelet tjekker for opdateringer. Produktion bør bruge Stable.',
        de: 'Wählen Sie, wo das Panel Updates prüft. Produktionsserver sollten Stable nutzen.',
        en: 'Choose where the panel checks for updates. Production servers should use Stable.',
        es: 'Elige de dónde el panel busca actualizaciones. En producción usa Stable.',
        fi: 'Valitse mistä paneeli tarkistaa päivitykset. Tuotannossa käytä Stablea.',
        fr: 'Choisissez la source des mises à jour. En production, utilisez Stable.',
        hi: 'Choose where the panel checks for updates. Production servers should use Stable.',
        hu: 'Válassza ki, honnan ellenőrzi a panel a frissítéseket. Éles rendszereken Stable.',
        id: 'Pilih sumber pembaruan panel. Server produksi gunakan Stable.',
        it: 'Scegli da dove il pannello controlla gli aggiornamenti. In produzione usa Stable.',
        ja: 'パネルが更新を確認するソースを選択します。本番は Stable を使用してください。',
        ko: '패널이 업데이트를 확인할 소스를 선택하세요. 운영 서버는 Stable을 사용하세요.',
        nb: 'Velg hvor panelet sjekker oppdateringer. Produksjon bør bruke Stable.',
        nl: 'Kies waar het paneel updates controleert. Productie moet Stable gebruiken.',
        pl: 'Wybierz skąd panel pobiera aktualizacje. Na produkcji używaj Stable.',
        pt: 'Escolha de onde o painel verifica atualizações. Produção deve usar Stable.',
        ro: 'Alege sursa actualizărilor. Pe producție folosește Stable.',
        sv: 'Välj var panelen söker uppdateringar. Produktion ska använda Stable.',
        th: 'เลือกแหล่งที่แผงตรวจสอบอัปเดต โปรดักชันควรใช้ Stable',
        tr: 'Panelin güncellemeleri nereden kontrol edeceğini seçin. Üretimde Stable kullanın.',
        uk: 'Оберіть джерело оновлень для панелі. На продакшені використовуйте Stable.',
        vi: 'Chọn nguồn panel kiểm tra cập nhật. Môi trường production nên dùng Stable.',
        zh: '选择面板检查更新的来源。生产环境请使用 Stable。',
        'zh-TW': '選擇面板檢查更新的來源。正式環境請使用 Stable。'
    },
    channel_pick_label: {
        en: 'Switch to', pl: 'Przełącz na', de: 'Wechseln zu', fr: 'Basculer vers', es: 'Cambiar a',
        cs: 'Přepnout na', da: 'Skift til', fi: 'Vaihda', it: 'Passa a', nl: 'Overschakelen naar',
        pt: 'Mudar para', sv: 'Byt till', nb: 'Bytt til', ro: 'Comută la', uk: 'Перемкнути на',
        ru: 'Switch to', ja: '切り替え', ko: '전환', zh: '切换到', 'zh-TW': '切換到',
        ar: 'Switch to', hi: 'Switch to', hu: 'Váltás', id: 'Beralih ke', th: 'Switch to', tr: 'Geç', vi: 'Chuyển sang'
    },
    channel_apply_hint: {
        en: 'The change is saved immediately after you confirm. Then click Check for updates.',
        pl: 'Po potwierdzeniu zmiana zapisuje się od razu. Następnie kliknij Sprawdź aktualizacje.',
        de: 'Nach Bestätigung wird sofort gespeichert. Dann „Auf Updates prüfen“ klicken.',
        fr: 'Après confirmation, le changement est enregistré. Puis cliquez sur Vérifier les mises à jour.',
        es: 'Tras confirmar se guarda al instante. Luego pulse Comprobar actualizaciones.',
        cs: 'Po potvrzení se změna uloží. Poté klikněte na Zkontrolovat aktualizace.',
        da: 'Gemmes straks efter bekræftelse. Klik derefter Tjek for opdateringer.',
        fi: 'Tallennetaan heti vahvistuksen jälkeen. Sitten Tarkista päivitykset.',
        it: 'Salvato subito dopo la conferma. Poi clicca Controlla aggiornamenti.',
        nl: 'Wordt direct opgeslagen na bevestiging. Klik daarna op Controleren op updates.',
        pt: 'Gravado após confirmar. Depois clique em Verificar atualizações.',
        sv: 'Sparas direkt efter bekräftelse. Klicka sedan Sök uppdateringar.',
        nb: 'Lagres etter bekreftelse. Klikk deretter Se etter oppdateringer.',
        ro: 'Se salvează după confirmare. Apoi apăsați Verifică actualizări.',
        uk: 'Зберігається одразу після підтвердження. Потім натисніть Перевірити оновлення.',
        ja: '確認後すぐに保存されます。その後「更新を確認」をクリック。',
        ko: '확인 후 즉시 저장됩니다. 그다음 업데이트 확인을 클릭하세요.',
        zh: '确认后立即保存。然后点击检查更新。',
        'zh-TW': '確認後立即儲存。然後按檢查更新。',
        ar: 'The change is saved immediately after you confirm. Then click Check for updates.',
        hi: 'The change is saved immediately after you confirm. Then click Check for updates.',
        hu: 'Megerősítés után azonnal mentés. Ezután kattintson a Frissítések ellenőrzése gombra.',
        id: 'Disimpan setelah konfirmasi. Lalu klik Periksa pembaruan.',
        th: 'The change is saved immediately after you confirm. Then click Check for updates.',
        tr: 'Onaydan sonra kaydedilir. Ardından Güncellemeleri kontrol et.',
        vi: 'Lưu ngay sau khi xác nhận. Sau đó bấm Kiểm tra cập nhật.'
    },
    channel_confirm_switch: {
        en: 'Switch update source from {from} to {to}? Your installed commit baseline stays the same until you run Check for updates.',
        pl: 'Przełączyć źródło aktualizacji z {from} na {to}? Zainstalowany commit pozostaje do momentu Sprawdź aktualizacje.',
        de: 'Update-Quelle von {from} auf {to} wechseln? Installierter Commit bleibt bis „Auf Updates prüfen“.',
        fr: 'Passer la source de {from} à {to} ? Le commit installé reste jusqu’à Vérifier les mises à jour.',
        es: '¿Cambiar origen de {from} a {to}? El commit instalado se mantiene hasta comprobar actualizaciones.',
        cs: 'Přepnout zdroj z {from} na {to}? Nainstalovaný commit zůstane do kontroly aktualizací.',
        da: 'Skift kilde fra {from} til {to}? Installeret commit beholdes indtil tjek for opdateringer.',
        fi: 'Vaihda lähde {from} → {to}? Asennettu commit pysyy kunnes tarkistat päivitykset.',
        it: 'Passare origine da {from} a {to}? Il commit installato resta fino a Controlla aggiornamenti.',
        nl: 'Bron wijzigen van {from} naar {to}? Geïnstalleerde commit blijft tot Controleren op updates.',
        pt: 'Mudar origem de {from} para {to}? O commit instalado mantém-se até verificar atualizações.',
        sv: 'Byt källa från {from} till {to}? Installerad commit kvar tills du söker uppdateringar.',
        nb: 'Bytt kilde fra {from} til {to}? Installert commit beholdes til oppdateringssjekk.',
        ro: 'Comutați sursa de la {from} la {to}? Commitul instalat rămâne până la verificarea actualizărilor.',
        uk: 'Перемкнути джерело з {from} на {to}? Встановлений commit лишається до перевірки оновлень.',
        ja: '更新元を {from} から {to} に切り替えますか？「更新を確認」まで現在の commit はそのままです。',
        ko: '{from}에서 {to}(으)로 전환할까요? 업데이트 확인 전까지 설치된 commit은 유지됩니다.',
        zh: '将更新源从 {from} 切换到 {to}？在点击检查更新之前，已安装的 commit 基准不变。',
        'zh-TW': '將更新來源從 {from} 切換到 {to}？在按檢查更新之前，已安裝的 commit 基準不變。',
        ar: 'Switch update source from {from} to {to}? Your installed commit baseline stays the same until you run Check for updates.',
        hi: 'Switch update source from {from} to {to}? Your installed commit baseline stays the same until you run Check for updates.',
        hu: 'Frissítési forrás váltása {from} → {to}? A telepített commit a frissítés-ellenőrzésig változatlan.',
        id: 'Ganti sumber dari {from} ke {to}? Commit terpasang tetap sampai periksa pembaruan.',
        th: 'Switch update source from {from} to {to}? Your installed commit baseline stays the same until you run Check for updates.',
        tr: 'Kaynağı {from} → {to} olarak değiştir? Yüklü commit, güncelleme kontrolüne kadar aynı kalır.',
        vi: 'Chuyển nguồn từ {from} sang {to}? Commit đã cài giữ nguyên cho đến khi kiểm tra cập nhật.'
    },
    channel_save: {
        ar: 'تبديل القناة', cs: 'Přepnout kanál', da: 'Skift kanal', de: 'Kanal wechseln',
        en: 'Switch channel', es: 'Cambiar canal', fi: 'Vaihda kanavaa', fr: 'Changer de canal',
        hi: 'Switch channel', hu: 'Csatorna váltása', id: 'Ganti saluran', it: 'Cambia canale',
        ja: 'チャンネル切替', ko: '채널 전환', nb: 'Bytt kanal', nl: 'Kanaal wisselen',
        pl: 'Przełącz kanał', pt: 'Mudar canal', ro: 'Comută canalul', sv: 'Byt kanal',
        th: 'Switch channel', tr: 'Kanalı değiştir', uk: 'Перемкнути канал', vi: 'Đổi kênh',
        zh: '切换通道', 'zh-TW': '切換通道'
    },
    channel_saved: {
        ar: 'تم تبديل القناة. انقر للتحقق من التحديثات.', cs: 'Kanál přepnut. Klikněte na Zkontrolovat aktualizace.',
        da: 'Kanal skiftet. Klik Tjek for opdateringer.', de: 'Kanal gewechselt. Klicken Sie auf Auf Updates prüfen.',
        en: 'Update channel switched. Click Check for updates to refresh.', es: 'Canal cambiado. Pulse Comprobar actualizaciones.',
        fi: 'Kanava vaihdettu. Klikkaa Tarkista päivitykset.', fr: 'Canal changé. Cliquez sur Vérifier les mises à jour.',
        hi: 'Update channel switched. Click Check for updates to refresh.', hu: 'Csatorna váltva. Kattintson a Frissítések ellenőrzése gombra.',
        id: 'Saluran diganti. Klik Periksa pembaruan.', it: 'Canale cambiato. Clicca Controlla aggiornamenti.',
        ja: 'チャンネルを切り替えました。「更新を確認」をクリックしてください。', ko: '채널이 전환되었습니다. 업데이트 확인을 클릭하세요.',
        nb: 'Kanal byttet. Klikk Se etter oppdateringer.', nl: 'Kanaal gewijzigd. Klik op Controleren op updates.',
        pl: 'Kanał zmieniony. Kliknij Sprawdź aktualizacje.', pt: 'Canal alterado. Clique em Verificar atualizações.',
        ro: 'Canal comutat. Apăsați Verifică actualizări.', sv: 'Kanal bytt. Klicka Sök uppdateringar.',
        th: 'Update channel switched. Click Check for updates to refresh.', tr: 'Kanal değiştirildi. Güncellemeleri kontrol et.',
        uk: 'Канал змінено. Натисніть Перевірити оновлення.', vi: 'Đã đổi kênh. Bấm Kiểm tra cập nhật.',
        zh: '通道已切换。请点击检查更新。', 'zh-TW': '通道已切換。請按檢查更新。'
    },
