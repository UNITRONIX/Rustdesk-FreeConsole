...
- Full text: [LICENSE](https://github.com/UNITRONIX/BetterDesk/blob/main/LICENSE)
...
Active [GitHub Sponsors](https://github.com/sponsors/UNITRONIX) at **$50/month or above** (Bronze, Silver, Gold) and **Honorary Supporters** may receive an optional **Commercial Grant**:
...
Details: [COMMERCIAL-GRANT.md](https://github.com/UNITRONIX/BetterDesk/blob/main/docs/COMMERCIAL-GRANT.md) and [SPONSORS.md](https://github.com/UNITRONIX/BetterDesk/blob/main/SPONSORS.md).
