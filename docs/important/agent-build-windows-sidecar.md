...
- Sets HOME=/home/$BUILD_USER, CARGO_HOME=/home/$BUILD_USER/.cargo, CARGO_TARGET_DIR=/var/cache/betterdesk-build.
...
- cargo-xwin requires rustup target x86_64-pc-windows-msvc (NOT gnu). Uses rust-lld for lld-link, symlinks clang-cl→/usr/bin/clang in ~/.cache/cargo-xwin (created by root; non-root $BUILD_USER can't overwrite → "Failed to setup clang-cl symlink / Permission denied"). Run worker-context builds as root.
